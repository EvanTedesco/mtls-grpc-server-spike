...
const (
	SigningService_Sign_FullMethodName = "/greet.SigningService/Sign"
)
...
func (c *signingServiceClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error) {
	...
	err := c.cc.Invoke(ctx, SigningService_Sign_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SigningService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "greet.SigningService",
